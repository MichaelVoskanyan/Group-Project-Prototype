...
namespace CS3280_Group_Project
{
    ...
    public partial class wndSearch : Window
    {
        ...
        private void cboInvoiceNumber_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            try
            {
                if (cboInvoiceNumber.SelectedItem is null)
                {
                    return;
                }
                ID = true;
                ...
                orderID = (int)cboInvoiceNumber.SelectedItem;
        ...
        private void cboInvoiceDate_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            try
            {
                if (cboInvoiceDate.SelectedItem is null)
                {
                    return;
                }
                date = true;
                ...
                orderdate = (DateTime)cboInvoiceDate.SelectedItem;
        ...
        private void cboTotalCharge_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            try
            {
                if (cboTotalCharge.SelectedItem is null)
                {
                    return;
                }
                total = true;
                ...
                ordertotal = (decimal)cboTotalCharge.SelectedItem;
        ...
        private void btnSelect_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    this.Close();
                    MainWindow = new MainWindow((clsOrder)searchOrderGrid.SelectedItem);
